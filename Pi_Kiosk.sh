...
xte "key Return" -x:0
xte "str @/home/pi/Trello-Kiosk/trello-kiosk.sh /b/RZBwe6aa/blk-farm-projects trello@blkfarms.com kcIF0&3*@c > /dev/nul> 2>&1" -x:0
...
sleep 15s;
xte "str sudo chmod 755 /home/pi/Trello-Kiosk/trello-kiosk.sh" -x:0
sleep 5s;
xte "str sudo chmod 755 /home/pi/Trello-Kiosk/tab_switcher.sh" -x:0
